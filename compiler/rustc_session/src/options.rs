...
options! {
    ...
    crash_diagnostics: Option<bool> = (None, parse_opt_bool, [UNTRACKED],
        "enable reproducer generation on crash (default: yes on nightly/dev)"),
    crash_diagnostics_dir: Option<PathBuf> = (None, parse_opt_pathbuf, [UNTRACKED],
        "directory to write reproducer to"),
